...
public interface PaymentList extends Remote {
	...
	public ArrayList<Payment> retreiveCustomerInsurancePayment(String customerId, String selectedInsuranceId)
	...
	public ArrayList<String> retreiveDateStatusById(String selectedCustomerId, String selectedInsuranceId)
			throws RemoteException;
